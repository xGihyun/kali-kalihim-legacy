import { c as create_ssr_component, i as getContext, h as add_attribute, k as subscribe, n as noop } from "../../../chunks/index3.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_user();
  return `${$user.auth_data.is_logged_in && !$user.auth_data.is_registered ? `<div class="w-full flex h-full flex-col items-center justify-center"><div class="p-4 variant-filled-surface rounded-md"><form method="post" action="/register"><label class="label"><span>First Name</span>
				...
				<label class="label"><span>Section</span>
					<select class="input" size="1" value="section1" name="section" required><option value="section-1">Section 1</option><option value="section-2">Section 2</option><option value="section-3">Section 3</option><option value="section-4">Section 4</option><option value="section-5">Section 5</option></select></label>
				...
				<button class="variant-filled-primary rounded-md p-2">Register</button></form></div></div>` : `${!$user.auth_data.is_logged_in && !$user.auth_data.is_registered ? `<div class="flex h-full flex-col items-center justify-center"><h1 class="font-gt-walsheim-pro-medium text-center text-9xl uppercase select-none mb-10">Kali Kalihim
		</h1>
